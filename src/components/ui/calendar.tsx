  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_dropdowns: 'flex justify-center gap-1 [&>.rdp-vhidden]:hidden',
        nav: 'space-x-1 flex items-center mt-[-14px]',
        nav_button: cn(
        ...
        day_selected:
          'border-0 bg-primary text-primary-foreground hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
