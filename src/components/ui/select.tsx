...
const selectTriggerVariants = cva('', {
  variants: {
    variant: {
      ...
      ghost:
        'flex h-10 w-auto items-center justify-between rounded-md border border-input px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
    },
  },
  defaultVariants: {
    variant: 'default',
...
const SelectTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & { variant?: 'ghost' | 'default' }
